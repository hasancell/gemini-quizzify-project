...
class QuizGenerator:
    ...
    def generate_quiz(self) -> list:
        ...
        for _ in range(self.num_questions):
            ...
            question_str = self.generate_question_with_vectorstore() # generate question
            
            
            try:
                question = json.loads(question_str) # Decode JSON
            ...
            if self.validate_question(question):
                ...
                self.question_bank.append(question) # Add to question bank
            else:
...
if __name__ == "__main__":
    ...
    with screen.container():
        ...
        embed_client = EmbeddingClient(**embed_config) # Initialize from EmbeddingClient class
